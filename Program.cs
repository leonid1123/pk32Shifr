...
//
//метод шифрования - что делает? что возвращает? какие параметры?
//делает: шифрует слово
//возвращает: зашифрованное слово
//параметр: исходное слово
//метод расшифрования - что делает? что возвращает? какие параметры?
//делает: расшифровывает слово
//возвращает: расшифрованное слово
//параметр: зашифрованное слово
//запись в файл - внутри методов или собственный метод?
